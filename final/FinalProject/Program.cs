...
class Program
{
    ...
    {
        Console.WriteLine("We got here 0");
        int credits  = 2000;
        ...
        string sithScoutClassName = "Harrower-Class Dreadnought";
        string sithCruiserClassName = "Terminus-Class Destroyer";
        string sithDreadnaughtClassName = "Fury-Class Interceptor";
        Faction sithEmpire = new Faction(credits, sithCapital, sithAdmirals, sithResearchOptions, sithMiningEfficiency, sithIndustry, sithFacilities, sithStationHealth, sithManeuvering, sithWeaponStrength, sithShieldStrength, sithShipHealth, sithCost, sithResearchEfficiency, sithRepairRate, sithScoutClassName, sithCruiserClassName, sithDreadnaughtClassName);
